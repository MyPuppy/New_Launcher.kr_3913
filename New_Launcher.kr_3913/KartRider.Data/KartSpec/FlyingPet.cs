...
namespace KartRider
{
    public class FlyingPet
    {
        ...
        {
            if (StartGameData.FlyingPet_id == 1 || StartGameData.FlyingPet_id == 2 || StartGameData.FlyingPet_id == 3 || StartGameData.FlyingPet_id == 4 || StartGameData.FlyingPet_id == 5)
            {
            ...
            else if (StartGameData.FlyingPet_id == 6)
            {
                FlyingPet.DragFactor = 0f;
                FlyingPet.ForwardAccelForce = 0f;
                FlyingPet.DriftEscapeForce = 0f;
            ...
            else if (StartGameData.FlyingPet_id == 7 || StartGameData.FlyingPet_id == 8 || StartGameData.FlyingPet_id == 9 || StartGameData.FlyingPet_id == 10 || StartGameData.FlyingPet_id == 11)
            {
                FlyingPet.DragFactor = 0f;
                FlyingPet.ForwardAccelForce = 0f;
            ...
            else if (StartGameData.FlyingPet_id == 12)
            {
                FlyingPet.DragFactor = 0f;
                FlyingPet.ForwardAccelForce = 0f;
            ...
            else if (StartGameData.FlyingPet_id == 13 || StartGameData.FlyingPet_id == 14 || StartGameData.FlyingPet_id == 15 || StartGameData.FlyingPet_id == 16 || StartGameData.FlyingPet_id == 17)
            {
                FlyingPet.DragFactor = 0f;
                FlyingPet.ForwardAccelForce = 0f;
                FlyingPet.DriftEscapeForce = 0f;
            ...
            else if (StartGameData.FlyingPet_id == 18)
            {
                FlyingPet.DragFactor = 0f;
                FlyingPet.ForwardAccelForce = 0f;
                FlyingPet.DriftEscapeForce = 0f;
