...
namespace RiderData
{
    public static class NewRider
    {
        ...
        public static short Value3 = 100;
        ...
        public static void NewRiderData()
        {
            using (OutPacket oPacket = new OutPacket("PrGetRider"))
            {
                ...
                if (LauncherSystem.KartOld_SN == SetRiderItem.Set_KartSN)
                {
                ...
                if (LauncherSystem.KartOld_SN == SetRiderItem.Set_KartSN)
                {
                    oPacket.WriteShort(LauncherSystem.KartOld_SN);
        ...
        {
            NewRider.Kart_Old_Cut = 289;
            NewRider.MaxKart = 1017;

            LauncherSystem.KartOld_SN = 1;
            LauncherSystem.KartSN = 1000;
        }
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= Character; i++)//Character
                {
                    if (i == 47 || i == 48 || i == 63 || i == 116 || i == 117 || i == 122 || i == 124 || i == 128 || i == 130 || i == 134 ||
                        i == 137 || i == 144 || i == 147 || i == 149 || i == 153 || i == 154 || i == 159 || i == 163 || i == 175 || i == 176 ||
                        i == 180 || i == 181 || i == 184 || i == 192 || i == 193 || i == 194 || i == 195 || i == 196 || i == 197 || i == 211 ||

                        i == 33 || i == 34 || i == 35 || i == 36 || i == 45 || i == 52 || i == 56 || i == 57 || i == 58 || i == 59 ||
                        i == 67 || i == 70 || i == 79 || i == 80 || i == 81 || i == 83 || i == 85 || i == 110 || i == 112 || i == 121 || 
                        i == 126 || i == 132 || i == 152 || i == 155 || i == 162 || i == 185 || i == 203)
                    {
                    }
                    else
                    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= Pet; i++)
                {
                    if (i == 8 || i == 10 || i == 11 || i == 14 || i == 18 || i == 50 || i == 77 || i == 85 || i == 91 || i == 92 || 
                        i == 105 || i == 107 || i == 120 || i == 126 || i == 127 || i == 128 || i == 129)
                    {
                    }
                    else
                    {
        ...
        public static void HandGearL()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HandGearL = 331;
                oPacket.WriteInt(HandGearL + 6 - 75);
        ...
        {
            short Plant_Engine = 23;
            short Plant_handlebar = 15;
            short Plant_Wheel = 23;
            short Plant_Kits = 30;
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                oPacket.WriteInt(1);
                oPacket.WriteInt(1);
                oPacket.WriteInt(Plant_Engine + Plant_handlebar + Plant_Wheel + Plant_Kits);
                for (short i = 1; i <= Plant_Engine; i++)
                {
                ...
                for (short i = 1; i <= Plant_handlebar; i++)
                {
        ...
        public static void Lottery()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Lottery = 7;
                oPacket.WriteInt(Lottery);
                for (short i = 558; i <= 699; i++)
                {
                    if (i == 558 || i == 561 || i == 570 || i == 623 || i == 631 || i == 697 || i == 699)
                    {
                        oPacket.WriteShort(24);
                        oPacket.WriteShort(i);
                        oPacket.WriteShort(0);
                        oPacket.WriteShort(NewRider.Value3);
                        oPacket.WriteByte((byte)((Program.PreventItem ? 1 : 0)));
                        oPacket.WriteByte(0);
                        oPacket.WriteShort(-1);
                        oPacket.WriteShort(0);
        ...
        public static void pcCafeConfig()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                oPacket.WriteInt(1);
                oPacket.WriteInt(1);
                oPacket.WriteInt(14);
                for (short i = 854; i <= 1009; i++)
                {
                    if (i == 904 || i == 1009 || i == 881 || i == 999 || i == 1003 || i == 920 || i == 882 || i == 1008 || i == 905 || i == 872 || i == 891 || i == 963 || i == 935 || i == 854)
                    {
                        oPacket.WriteShort(3);
                        oPacket.WriteShort(i);
                        oPacket.WriteShort(2);
